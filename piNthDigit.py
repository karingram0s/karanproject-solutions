...
#####---- main
print('This will print the value of pi up to the desired number of decimal places. Limit is up to 12 places.')
...
# print value of pi with /intinput/ number of places
print(Decimal(math.pi)/1)
